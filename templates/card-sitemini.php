<?php if ( ! defined( 'ABSPATH' ) ) { exit; }  ?>
        ...
        <div class="url-body mini">   
            <a href="<?php echo $url ?>" <?php echo ($sites_type == "sites" && get_post_meta($post->ID, '_goto', true))?'':nofollow($link_url, io_get_option('details_page')) ?> <?php echo $blank ?> data-id="<?php echo $post->ID ?>" data-url="<?php echo rtrim($link_url,"/") ?>" class="card <?php echo $is_views ?> mb-3 site-<?php echo $post->ID ?>" <?php echo $tooltip . ' ' . $is_html ?> title="<?php echo $title ?>">
                <div class="card-body">
